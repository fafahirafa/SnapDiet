...
import com.snapdiet.env.BorderedText;
import com.snapdiet.env.ImageUtils;
import com.snapdiet.env.Logger;
import com.snapdiet.tflite.Classifier.Recognition;
...
public class MultiBoxTracker {
  ...
  public com.snapdiet.tracking.ObjectTracker objectTracker;
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      final com.snapdiet.tracking.ObjectTracker.TrackedObject trackedObject = recognition.trackedObject;
  ...
  public synchronized void onFrame(
    ...
    if (objectTracker == null && !initialized) {
      com.snapdiet.tracking.ObjectTracker.clearInstance();

      logger.i("Initializing ObjectTracker: %dx%d", w, h);
      objectTracker = com.snapdiet.tracking.ObjectTracker.getInstance(w, h, rowStride, true);
      frameWidth = w;
      frameHeight = h;
...
//        Toast.makeText(context, message, Toast.LENGTH_LONG).show();
  ...
  private void handleDetection(
    ...
    final com.snapdiet.tracking.ObjectTracker.TrackedObject potentialObject =
  ...
  private static class TrackedRecognition {
    com.snapdiet.tracking.ObjectTracker.TrackedObject trackedObject;
    RectF location;
